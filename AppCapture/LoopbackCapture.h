...
public:
  ...
  METHODASYNCCALLBACK(CLoopbackCapture, StartCapture, OnStartCapture);    //m_xStartCapture
  METHODASYNCCALLBACK(CLoopbackCapture, StopCapture, OnStopCapture);      //m_xStopCapture
  METHODASYNCCALLBACK(CLoopbackCapture, SampleReady, OnSampleReady);      //m_xSampleReady
  METHODASYNCCALLBACK(CLoopbackCapture, FinishCapture, OnFinishCapture);  //m_xFinishCapture
