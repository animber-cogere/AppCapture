...
HRESULT CLoopbackCapture::ActivateAudioInterface(
  /*DWORD processId, bool includeProcessTree*/
)
{
  return SetDeviceStateErrorIfFailed([&]() -> HRESULT
    {
      ...
      audioclientActivationParams.ProcessLoopbackParams.TargetProcessId = 1234;// processId;
...
HRESULT CLoopbackCapture::StartCaptureAsync(
  /*DWORD processId, bool includeProcessTree,*/ PCWSTR outputFileName
)
{
